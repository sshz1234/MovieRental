...
namespace COMP2084Assign2Real.Controllers
{
    public class UserRentalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserRentalId,owingAmount,movieTitle,dueDate,rentalDate")] UserRental userRental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserRentalId,owingAmount,movieTitle,dueDate,rentalDate")] UserRental userRental)
        {
